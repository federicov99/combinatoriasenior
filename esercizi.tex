...
\Ese In ogni vertice di un $n$-agono regolare ci sono alcune pedine. Su un vertice ce n'è una, su quello successivo $2$, su quello ulteriore $3$ e così via fino all'ultimo dove ce ne sono $n$. Ancora una volta con una mossa si possono scegliere $2$ qualsiasi pedine e spostarne una in un senso e l'altra in quello contrario. In quali vertici \`e possibile spostarle tutte?
